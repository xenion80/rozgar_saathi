...
public class AiCoachController {
    ...
    @PostMapping("/chat")
    public ResponseEntity<ApiResponse<AiCoachResponseDto>> chat(@RequestBody AiCoachRequestDto request) {
        try {
            String responseText = aiCoachService.getCoachResponse(request);
