              ...
              <form onSubmit={handleAddSkill} className="space-y-5">
                <div>
                  ...
                  <select
                    ...
                    className="flex h-10 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:ring-offset-2"
                  >
